  ...
  return (
    <>
      {isContainerOpen && (
        ...
        <div className="bg-[#BEB9A1] w-full md:w-[80%] lg:w-[70%] xl:w-[50%] h-screen md:h-auto overflow-hidden flex flex-col justify-center mx-auto mt-10 md:mt-[10%] mb-10 md:mb-[10%] px-4 md:px-8 py-5 rounded-md relative">
          ...
          <div className="grid-cols-[1fr,1fr] gap-[20px] lg:grid-cols-[5fr,1fr,1fr] grid">
            <div className="flex items-center">
              <h1 className="text-black font-merriweather text-2xl  mt-5 ml-4 font-semibold">
          ...
          <div className="overflow-y-auto p-4 h-[500px] text-black font-lora text-xl font-normal  ">
